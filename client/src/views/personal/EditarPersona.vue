<template>
	<div>
		<h1 class="fadeInDown">Editar Persona</h1>
		<b-form class="mt-3 fadeInRight delayed-02" @submit.prevent="guardarPersona()">
			<Input id="id" v-model="idPersona" titulo="ID" class="mb-2" disabled />
			<Input
