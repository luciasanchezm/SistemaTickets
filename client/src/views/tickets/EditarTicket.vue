<template>
  <div>
    ...
    <b-form @submit.prevent="guardarTicket()">
      ...
      />
      <div class="mb-3 row">
        <label class="col-sm-2 col-form-label text-start" for="prioridad"
          >Prioridad</label
        >
        <div class="col-sm-10">
          <b-form-select
        ...
        <span v-if="!validacionPrioridad" class="text-danger"
          >Campo obligatorio</span
        >
      </div>
      <div class="mb-3 row">
        <label class="col-sm-2 col-form-label text-start" for="persona"
          >Persona</label
        >
        <div class="col-sm-10">
          <b-form-select
        ...
        <span v-if="!validacionPersonaID" class="text-danger"
          >Campo obligatorio</span
        >
      </div>
      <div class="mb-3 row">
        <label class="col-sm-2 col-form-label text-start" for="categoria"
          >Categoría</label
        >
        <div class="col-sm-10">
          <b-form-select
        ...
        <span v-if="!validacionCategoriaID" class="text-danger"
          >Campo obligatorio</span
        >
      </div>

      <!-- 
				# Intentamos utilizar el componente, pero siempre nos 
...
export default {
  ...
  created() {
    ...
    this.listarCategoriasPorNombre({ all: false });
    this.obtenerTicket({
      id: this.$route.params.id,
      onComplete: (response) => {
